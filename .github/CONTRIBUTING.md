...
- Please ensure that there is adequate test coverage for your code: run `npm test` and see the `coverage` directory.
- Please lint your work; see [package.json](https://github.com/Alorel/express-decorated-router/blob/master/package.json).
